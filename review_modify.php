...
<form  name="board_form" method="post" action="review_insert.php?mode=modify&num=<?=$num?>&page=<?=$page?>"> 
        <div id="write_form">
	     <div id="write_form">
		<tr><td class="col1"> 닉네임 </td>
		<td class="col2"><?echo "{$_SESSION['id']}";?> </td>
		<td class="col3"></td>
		<td></td>
		<td></td>
		<td></td>
		...
		<td class="col2"><input type="text" name="subject" value="<?=$item_subject?>" size = 90 ></td>
		<td></td>
		<td></td>
		<td></td>
		<td></td>
		...
		<div id="write_row3">
			<tr><td class="col1"> 내용   </td>
			      <td class="col2"><textarea rows="15" cols="90" name="content"><?=$item_content?></textarea></td>
			<td></td>
			<td></td>
			<td></td>
			<td></td>
		...
		<a href="review.php?page=<?echo"$page";?>">
