...
<form name = "board_form" method = "psot" action ="list.php?mode =search">
...
?>
	<tr>
	     ...
	     <td id="list_item2"><a href="view.php?num=<?echo"$item_num";?>&page=<?echo"$page";?>"><?echo"$item_subject"; ?></a>
...
<div id = "button">
       <a href="list.php?page=<?=$page;?>"><input type="submit" value="목록" ></a>&nbsp;
...
<? 
	if($_SESSION['id']){
	  ...
	  echo " <a href='./write_form.php'><input type='submit'  value='글쓰기' ></a>";
	}
?>	
