...
<div id="view_button">
	<a href = "review.php?apge=<?=$page?>"><input type = "button" value = "목록"></a>&nbsp;

<? 
	if($_SESSION[id] == $item_id)
	{
?>
	        <a href="review_modify.php?num=<?=$num?>&page=<?=$page?>"><input type = "submit" value = "수정" ></a>&nbsp;
	        <a href="javascript:del('review_delete.php?num=<?=$num?>')"><input type = "submit" value = "삭제" ></a>&nbsp;
<?
	}
?>
<? 
	...
	{
?>
	       <a href="review_write_form.php"><input type = "submit" value = "글쓰기" ></a>
<?
	}
?>
